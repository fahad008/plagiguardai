				...
				<?php $this->load->view('subscription/navbar'); ?>
					...
					<div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
						...
						<div class="card-body p-9">
							<?php if (isset($customer_subscription) && !empty($customer_subscription)) {?>
							<!--begin::Row-->
							<div class="row mb-7">
								<!--begin::Label-->
								<label class="col-lg-4 fw-bold text-muted">Subscription</label>
								<!--end::Label-->
								<!--begin::Col-->
								<div class="col-lg-8">
									<span class="badge badge-light-<?php if(isset($customer_plan) && !empty($customer_plan)){ echo $customer_plan['color']; } ?> fw-bolder me-auto px-4 py-3"><?php if(isset($customer_plan) && !empty($customer_plan)){ echo $customer_plan['title']; } ?></span>
								</div>
								<!--end::Col-->
							</div>
							<!--end::Row-->
							...
							<div class="row mb-7">
								...
								<!--begin::Col-->
								<div class="col-lg-8">
									<span class="badge badge-light-success fw-bolder me-auto px-4 py-3"><?php if(isset($customer_plan) && !empty($customer_plan)){ if ($customer_plan['duration'] == '30') {
										echo "Monthly";
									}else{ echo "Yearly"; } } ?></span>
								</div>
								<!--end::Col-->
							</div>
							<!--end::Row-->
							...
							<div class="row mb-7">
								...
								<!--begin::Col-->
								<div class="col-lg-8">
									<span class="badge badge-light-success fw-bolder me-auto px-4 py-3"><?php if(isset($customer_subscription) && !empty($customer_subscription)){ echo $customer_subscription['status']; } ?></span>
								</div>
								<!--end::Col-->
							</div>
							<!--end::Row-->
							...
							<div class="row mb-7">
								...
								<!--begin::Col-->
								<div class="col-lg-8">
									<span class="badge badge-light-success fw-bolder me-auto px-4 py-3"><?php if (isset($customer_subscription) && !empty($customer_subscription)) { echo date('d M Y', strtotime($customer_subscription['start_date'])); }else{ echo '-----------'; } ?></span>
								</div>
								<!--end::Col-->
							</div>
							<!--end::Row-->
							...
							<div class="row mb-7">
								...
								<!--begin::Col-->
								<div class="col-lg-8">
									<span class="badge badge-light-danger fw-bolder me-auto px-4 py-3"><?php if (isset($customer_subscription) && !empty($customer_subscription)) { echo date('d M Y', strtotime($customer_subscription['end_date'])); }else{ echo '-----------'; } ?></span>
								</div>
								<!--end::Col-->
							</div>
							<!--end::Row-->
							...
							<div class="row mb-7">
								<!--begin::Label-->
								<label class="col-lg-4 fw-bold text-muted">Remaining Credits</label>
								<!--end::Label-->
								<!--begin::Col-->
								<div class="col-lg-8">
...
<script src="<?php echo base_url(); ?>assets/js/custom/apps/resellers/list/invoices.js"></script>
