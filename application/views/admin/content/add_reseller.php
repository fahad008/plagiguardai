	...
	<div id="kt_header" class="header">
		...
		<div class="container d-flex align-items-center justify-content-between" id="kt_header_container">
			...
			<div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-5 pb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_container'}">
				<!--begin::Heading-->
				<h1 class="d-flex flex-column text-dark fw-bolder my-0 fs-1">Add Reseller</h1>
				<!--end::Heading-->
			</div>
			<!--end::Page title=-->
			<!--begin::Wrapper-->
			...
			<div class="card">
				...
				<div class="card-body p-0">
					...
					<div class="card-px text-center py-20 my-10">
						...
						<br />Stay organized and in control</p>
						<!--end::Description-->
						<!--begin::Action-->
						<a href="javascript: void(0)" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_add_reseller">Add Reseller</a>
						<!--end::Action-->
					</div>
					<!--end::Wrapper-->
					<!--begin::Illustration-->
