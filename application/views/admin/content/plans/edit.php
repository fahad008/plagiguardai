	...
	<div id="kt_header" class="header">
		...
		<div class="container d-flex align-items-center justify-content-between" id="kt_header_container">
			...
			<div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-5 pb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_container'}">
				<!--begin::Heading-->
				<h1 class="d-flex flex-column text-dark fw-bolder my-0 fs-1">Edit Plan</h1>
				<!--end::Heading-->
			</div>
			<!--end::Page title=-->
			<!--begin::Wrapper-->
				...
				<div class="card-body p-0">
					...
					<div class="card mb-5 mb-xl-10">
						...
						<div id="kt_add_plan_area" class="collapse show">
							<!--begin::Form-->
							<form id="kt_plan_form" class="form" action="<?php echo base_url().'admin/plans/edit_plan/' ?>">
								<!--begin::Card body-->
								<div class="card-body border-top p-9">
									<input type="hidden" name="plan_id" value="<?php echo $plan_info['id']; ?>">
									<!--begin::Input group-->
									<div class="row mb-6">
										<!--begin::Label-->
										...
										<div class="col-lg-8 fv-row">
												<input type="text" name="title" class="form-control form-control-lg form-control-solid" placeholder="Title" value="<?php echo $plan_info['title']; ?>"/>
										</div>
										<!--end::Col-->
									</div>
									<!--end::Input group-->
									...
									<div class="row mb-6">
										...
										<!--begin::Col-->
										<div class="col-lg-8 fv-row">
											<textarea class="form-control form-control-lg form-control-solid" rows="3" name="description" placeholder="Type Plan Description"><?php echo $plan_info['description']; ?></textarea>
										</div>
										<!--end::Col-->
									</div>
									<!--end::Input group-->
									<div class="row mb-6">
										...
										<!--begin::Col-->
										<div class="col-lg-8 fv-row">
											<input type="number" name="credits" class="form-control form-control-lg form-control-solid" min="1" placeholder="Credits" value="<?php echo $plan_info['credits']; ?>" onkeydown="return event.key !== '-' && event.key !== 'e' && event.key !== 'E' && event.key !== '.'" oninput="this.value = this.value.replace(/[^0-9]/g, ''); if(this.value.startsWith('0')) this.value = this.value.replace(/^0+/, '')"/>
										</div>
										<!--end::Col-->
									</div>
									<div class="row mb-6">
										...
										<!--begin::Col-->
										<div class="col-lg-8 fv-row">
											<input type="number" name="price" class="form-control form-control-lg form-control-solid" min="1" placeholder="price" value="<?php echo $plan_info['price']; ?>" onkeydown="return event.key !== '-' && event.key !== 'e' && event.key !== 'E' && event.key !== '.'" oninput="this.value = this.value.replace(/[^0-9]/g, ''); if(this.value.startsWith('0')) this.value = this.value.replace(/^0+/, '')"/>
										</div>
										<!--end::Col-->
									</div>
									<div class="row mb-6">
										...
										<div class="col-lg-8 fv-row">
											<select name="duration" data-control="select2" data-hide-search="true" data-placeholder="Select a Duration..." class="form-select form-select-solid">
												<option <?php if ($plan_info['duration'] == '30') { echo 'selected'; } ?> value="30">Monthly</option>
												<option <?php if ($plan_info['duration'] == '365') { echo 'selected'; } ?> value="365">Yearly</option>
											</select>
										</div>
									</div>
									<div class="row mb-6">
										...
										<div class="col-lg-8 fv-row">
											<select name="color" data-control="select2" data-hide-search="true" data-placeholder="Select a Color..." class="form-select form-select-solid">
												...
												<?php if (isset($plans_text) && !empty($plans_text)) {
													foreach ($plans_text as $key => $value) { ?>
													<option <?php if ($plan_info['color'] == $value) { echo 'selected'; } ?> value="<?php echo $value; ?>"><?php echo $value; ?></option>
												<?php } } ?>
											</select>
										</div>
									</div>
