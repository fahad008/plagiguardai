...
<div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
	...
	<div id="kt_header" class="header">
		...
		<div class="container d-flex align-items-center justify-content-between" id="kt_header_container">
			...
			<div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-5 pb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_container'}">
				<!--begin::Heading-->
				<h1 class="d-flex flex-column text-dark fw-bolder my-0 fs-1">Customer Details</h1>
				<!--end::Heading-->
			</div>
			<!--end::Page title=-->
			<!--begin::Wrapper-->
		...
		<div class="container-xxl" id="kt_content_container">
			...
			<div class="d-flex flex-column flex-xl-row">
				...
				<div class="flex-column flex-lg-row-auto w-100 w-xl-350px mb-10">
						...
						<div class="card-body pt-15">
							...
							<div class="d-flex flex-center flex-column mb-5">
								...
								<div class="symbol symbol-100px symbol-circle mb-7">
									<img src="<?php echo $avatar; ?>" alt="<?php echo $customer_info['full_name']; ?>" />
								</div>
								<!--end::Avatar-->
								<!--begin::Name-->
								<a href="Javascript: void(0)" class="fs-3 text-gray-800 text-hover-primary fw-bolder mb-1"><?php echo $customer_info['full_name']; ?></a>
								<!--end::Name-->
								<!--begin::Position-->
								<div class="fs-5 fw-bold text-muted mb-6"><?php echo $customer_info['role']; ?></div>
								<!--end::Position-->
							</div>
							<!--end::Summary-->
							...
							<div id="kt_customer_view_details" class="collapse show">
								<div class="py-5 fs-6">
									...
									<div class="text-gray-600" id="customer_name"><?php echo $customer_info['full_name']; ?></div>
									<!--begin::Details item-->
									<!--begin::Details item-->
									<div class="fw-bolder mt-5">Billing Email</div>
									<div class="text-gray-600">
										<a href="Javascript:void(0)" class="text-gray-600 text-hover-primary"><?php echo $customer_info['email']; ?></a>
									</div>
									<div class="fw-bolder mt-5">Email Status</div>
									<div class="text-gray-600">
										<span class="badge <?php if (isset($customer_info['email_verified']) && $customer_info['email_verified'] == 'yes') { echo "badge-success"; }else{ echo "badge-danger"; } ?>"><?php if (isset($customer_info['email_verified']) && $customer_info['email_verified'] == 'yes') { echo "Verified"; }else{ echo "Unverified"; } ?></span>
									</div>
									<!--begin::Details item-->
									<!--begin::Details item-->
									<div class="fw-bolder mt-5">Role</div>
									<div class="text-gray-600"><?php echo $customer_info['role']; ?></div>
									<!--begin::Details item-->
									<!--begin::Details item-->
									<div class="fw-bolder mt-5">Contact Phone</div>
									<div class="text-gray-600"><?php if (isset($customer_info['contact_number']) && $customer_info['contact_number'] != '') { echo $customer_info['contact_number']; }else{ echo '-----------'; } ?></div>
									<!--begin::Details item-->
									<!--begin::Details item-->
									<div class="fw-bolder mt-5">Country</div>
									<div class="text-gray-600"><?php if (isset($country) && $country['name'] != '') { echo $country['name']; }else{ echo '-----------'; } ?></div>
									<!--begin::Details item-->
								</div>
							</div>
							<!--end::Details content-->
					...
					<!--end::Card-->
					<?php if (isset($customer_plan) && !empty($customer_plan)) { ?>
					<!--begin::Connected Accounts-->
					<div class="card mb-5 mb-xl-8">
						<!--begin::Card header-->
						<div class="card-header border-0">
							<div class="card-title">
								<h3 class="fw-bolder m-0">Subscribed Plan</h3>
							</div>
						</div>
						<!--end::Card header-->
						<!--begin::Card body-->
						<div class="card-body pt-2">
							<span class="symbol symbol-50px me-2">
								<span class="symbol-label bg-light-<?php echo $customer_plan['color']; ?>">
									<span class="svg-icon svg-icon-3x svg-icon-<?php echo $customer_plan['color']; ?>">
							...
							<span class="badge badge-light-<?php echo $customer_plan['color']; ?> fw-bolder me-auto px-4 py-3 my-2" style="float: right !important;"><?php echo $customer_plan['title']; ?></span>
							<!--begin::Details toggle-->
							<div class="d-flex flex-stack fs-4 py-3">
								<div class="fw-bolder rotate collapsible" data-bs-toggle="collapse" href="#kt_plan_view_details" role="button" aria-expanded="false" aria-controls="kt_plan_view_details">Details
								<span class="ms-2 rotate-180">
									<!--begin::Svg Icon | path: icons/duotune/arrows/arr072.svg-->
									<span class="svg-icon svg-icon-3">
										<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
							...
							<div id="kt_plan_view_details" class="collapse show">
								<div class="py-5 fs-6">
									...
									<!--begin::Badge-->
									<!--begin::Details item-->
									<div class="fw-bolder">Credits</div>
									<div class="text-gray-600"><?php echo $customer_plan['credits']; ?></div>
									<!--begin::Details item-->
									<!--begin::Details item-->
									<div class="fw-bolder mt-5">Price</div>
									<div class="text-gray-600">
										<a href="Javascript:void(0)" class="text-gray-600 text-hover-primary"><?php echo $customer_plan['price']; ?> PKR</a>
									</div>
									<div class="fw-bolder mt-5">Status</div>
									<div class="text-gray-600">
										<span class="badge <?php if (isset($customer_subscription['status']) && $customer_subscription['status'] == 'active') { echo "badge-success"; }else if(isset($customer_subscription['status']) && $customer_subscription['status'] == 'expired'){ echo "badge-danger"; }else{ echo "badge-warning" ;} ?>"><?php if (isset($customer_subscription['status']) && $customer_subscription['status'] == 'active') { echo "Active"; }else if(isset($customer_subscription['status']) && $customer_subscription['status'] == 'expired'){ echo "Expired"; }else{ echo 'Inactive'; } ?></span>
									</div>
									<div class="fw-bolder mt-5">Start Date</div>
									<div class="text-gray-600">
										<span class="badge badge-success"><?php if (isset($customer_subscription) && !empty($customer_subscription)) { echo date('d M Y', strtotime($customer_subscription['start_date'])); }else{ echo '-----------'; } ?></span>
									</div>
									<div class="fw-bolder mt-5">Expiry Date</div>
									<div class="text-gray-600">
										<span class="badge badge-danger"><?php if (isset($customer_subscription) && !empty($customer_subscription)) { echo date('d M Y', strtotime($customer_subscription['end_date'])); }else{ echo '-----------'; } ?></span>
									</div>
								</div>
							</div>
							<!--end::Details content-->
				...
				<div class="flex-lg-row-fluid ms-lg-15">
					...
					<ul class="nav nav-custom nav-tabs nav-line-tabs nav-line-tabs-2x border-0 fs-4 fw-bold mb-8">
						<!--begin:::Tab item-->
						<li class="nav-item">
							<a class="nav-link text-active-primary pb-4 active" data-bs-toggle="tab" href="#kt_customer_view_overview_tab">Invoices</a>
						</li>
						<!--end:::Tab item-->
						<!--begin:::Tab item-->
						<li class="nav-item">
						...
						<li class="nav-item ms-auto">
							...
							<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-bold py-4 w-250px fs-6" data-kt-menu="true">
								...
								<div class="menu-item px-5">
									<a href="Javascript: void(0)" onclick="deleteCustomer(this)" class="menu-link text-danger px-5" data-id="<?php echo $customer_info['id']; ?>">Delete customer</a>
								</div>
								<!--end::Menu item-->
							</div>
							<!--end::Menu-->
							...
							<div class="card pt-4 mb-6 mb-xl-9">
								...
								<div class="card-body pt-0 pb-5">
									...
									<table class="table align-middle table-row-dashed gy-5" id="kt_table_customers_invoices">
										...
										<!--end::Table head-->
										<!--begin::Table body-->
										<tbody class="fs-6 fw-bold text-gray-600" data-action="<?php echo base_url().'admin/invoices/ajax_invoices/'; ?>" data-customerId="<?php echo $customer_info['id']; ?>">
										</tbody>
										<!--end::Table body-->
									</table>
									<!--end::Table-->
								...
								<div class="card-body py-0">
									...
									<div class="table-responsive">
										...
										<table class="table align-middle table-row-dashed fw-bold text-gray-600 fs-6 gy-5" id="kt_table_customers_logs">
											<!--begin::Table body-->
											<tbody>
												<?php if (isset($customer_logs) && !empty($customer_logs)) {
												...
												<tr>
													...
													<!--end::Badge=-->
													<!--begin::Status=-->
													<td><a target="_blank" href="<?php echo $value['public_link']; ?>" class="text-gray-600 text-hover-primary"><?php echo $value['public_link']; ?></a></td>
													<!--end::Status=-->
													<!--begin::Timestamp=-->
													<td class="pe-0 text-end min-w-200px"><?php echo date('d M Y', strtotime($value['created_at'])); ?></td>
													<!--end::Timestamp=-->
												</tr>
												<!--end::Table row-->
												<?php } }else{ ?>
													<tr class="odd"><td valign="top" colspan="6" class="dataTables_empty">No logs available</td></tr>
												<?php } ?>
											</tbody>
											<!--end::Table body-->
										</table>
			...
			<div class="modal fade" id="kt_modal_reseller_detail" tabindex="-1" aria-hidden="true">
				<!--begin::Modal dialog-->
								...
								<div class="mh-375px scroll-y me-n7 pe-7">
									...
									<div class="card mb-5 mb-xl-8">
										...
										<div class="d-flex flex-center flex-column py-5">
											<!--begin::Avatar-->
											<div class="symbol symbol-100px symbol-circle mb-7">
												<img src="<?php if(isset($reseller_avatar) && $reseller_avatar != ''){ echo $reseller_avatar; } ?>" alt="<?php if(isset($reseller_info) && !empty($reseller_info)){ echo $reseller_info->full_name; } ?>" />
											</div>
											<!--end::Avatar-->
											<!--begin::Name-->
	...
	<script>
		function deleteCustomer(el) {
		    ...
		    const customerName = $("#customer_name").text();
		    const del_url = "<?php echo base_url().'admin/customers/delete'; ?>";
		    Swal.fire({
                            ...
                            success: function(response) {
                                ...
                                if (response.status == 'success') {
                                    Swal.fire({
                                    	...
                                    	const redirect_url = "<?php echo base_url().'admin/customers/'; ?>";
