...
<div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
	...
	<div id="kt_header" class="header">
		...
		<div class="container d-flex align-items-center justify-content-between" id="kt_header_container">
			...
			<div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-5 pb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_container'}">
				<!--begin::Heading-->
				<h1 class="d-flex flex-column text-dark fw-bolder my-0 fs-1">Reseller Details</h1>
				<!--end::Heading-->
			</div>
			<!--end::Page title=-->
			<!--begin::Wrapper-->
			...
			<div class="d-flex flex-column flex-xl-row">
						...
						<div class="card-body pt-15">
							...
							<div class="d-flex flex-center flex-column mb-5">
								...
								<div class="symbol symbol-100px symbol-circle mb-7">
									<img src="<?php echo $avatar; ?>" alt="<?php echo $reseller_info['full_name']; ?>" />
								</div>
								<!--end::Avatar-->
								<!--begin::Name-->
								<a href="Javascript: void(0)" class="fs-3 text-gray-800 text-hover-primary fw-bolder mb-1"><?php echo $reseller_info['full_name']; ?></a>
								<!--end::Name-->
								<!--begin::Position-->
								<div class="fs-5 fw-bold text-muted mb-6"><?php echo $reseller_role_info['text']; ?></div>
								<!--end::Position-->
							</div>
							<!--end::Summary-->
							...
							<div id="kt_customer_view_details" class="collapse show">
								<div class="py-5 fs-6">
									...
									<div class="text-gray-600" id="reseller_name"><?php echo $reseller_info['full_name']; ?></div>
									<!--begin::Details item-->
									<!--begin::Details item-->
									<div class="fw-bolder mt-5">Billing Email</div>
									<div class="text-gray-600">
										<a href="Javascript:void(0)" class="text-gray-600 text-hover-primary"><?php echo $reseller_info['email']; ?></a>
									</div>
									<div class="fw-bolder mt-5">Email Status</div>
									<div class="text-gray-600">
										<span class="badge <?php if (isset($reseller_info['email_verified']) && $reseller_info['email_verified'] == 'yes') { echo "badge-success"; }else{ echo "badge-danger"; } ?>"><?php if (isset($reseller_info['email_verified']) && $reseller_info['email_verified'] == 'yes') { echo "Verified"; }else{ echo "Unverified"; } ?></span>
									</div>
									<!--begin::Details item-->
									<!--begin::Details item-->
									<div class="fw-bolder mt-5">Role</div>
									<div class="text-gray-600"><?php echo $reseller_role_info['text']; ?></div>
									<!--begin::Details item-->
									<!--begin::Details item-->
									<div class="fw-bolder mt-5">Contact Phone</div>
									<div class="text-gray-600"><?php if (isset($reseller_info['contact_number']) && $reseller_info['contact_number'] != '') { echo $reseller_info['contact_number']; }else{ echo '-----------'; } ?></div>
									<!--begin::Details item-->
									<!--begin::Details item-->
				...
				<div class="flex-lg-row-fluid ms-lg-15">
					...
					<ul class="nav nav-custom nav-tabs nav-line-tabs nav-line-tabs-2x border-0 fs-4 fw-bold mb-8">
						<!--begin:::Tab item-->
						<li class="nav-item">
							<a class="nav-link text-active-primary pb-4 active" data-bs-toggle="tab" href="#kt_customer_view_overview_tab">Customers</a>
						</li>
						<!--end:::Tab item-->
						<!--begin:::Tab item-->
						<li class="nav-item">
							<a class="nav-link text-active-primary pb-4" data-bs-toggle="tab" href="#kt_invoices_view_overview_tab">Invoices</a>
						</li>
						<!--end:::Tab item-->
						<!--begin:::Tab item-->
						<li class="nav-item ms-auto">
							...
							<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-bold py-4 w-250px fs-6" data-kt-menu="true">
								...
								<div class="menu-item px-5">
									<a href="Javascript: void(0)" onclick="deleteReseller(this)" class="menu-link text-danger px-5" data-id="<?php echo $reseller_info['id']; ?>">Delete customer</a>
								</div>
								<!--end::Menu item-->
							</div>
							<!--end::Menu-->
					...
					<div class="tab-content" id="myTabContent">
						...
						<div class="tab-pane fade show active" id="kt_customer_view_overview_tab" role="tabpanel">
							...
							<div class="card pt-4 mb-6 mb-xl-9">
								...
								<div class="card-body pt-0 pb-5">
									<!--begin::Table-->
									<table class="table align-middle table-row-dashed gy-5" id="kt_table_reseller_customers">
										<!--begin::Table head-->
										<thead class="border-bottom border-gray-200 fs-7 text-uppercase fw-bolder">
											<tr class="text-start text-muted gs-0">
												...
												<th class="min-w-100px">Email Status</th>
												<th class="min-w-125px">Date</th>
											</tr>
										</thead>
										<!--end::Table head-->
										<!--begin::Table body-->
										<tbody class="fs-6 fw-bold text-gray-600" data-action="<?php echo base_url().'admin/resellers/ajax_customer_list/'; ?>" data-resellerid="<?php echo $reseller_info['id']; ?>">
										</tbody>
										<!--end::Table body-->
									</table>
									<!--end::Table-->
						...
						<!--end:::Tab pane-->
						<!--begin:::Tab pane-->
						<div class="tab-pane fade" id="kt_invoices_view_overview_tab" role="tabpanel">
							<!--begin::Card-->
							<div class="card pt-4 mb-6 mb-xl-9">
								<!--begin::Card header-->
								<div class="card-header border-0">
								...
								<div class="card-body pt-0 pb-5">
									<!--begin::Table-->
									<table class="table align-middle table-row-dashed gy-5" id="kt_table_reseller_invoices">
										<!--begin::Table head-->
										<thead class="border-bottom border-gray-200 fs-7 text-uppercase fw-bolder">
											<tr class="text-start text-muted gs-0">
										...
										<!--end::Table head-->
										<!--begin::Table body-->
										<tbody class="fs-6 fw-bold text-gray-600" data-action="<?php echo base_url().'admin/invoices/ajax_reseller_invoices/'; ?>" data-resellerid="<?php echo $reseller_info['id']; ?>">
										</tbody>
										<!--end::Table body-->
									</table>
									<!--end::Table-->
	...
	<!--end::Footer-->
	<script>
		function deleteReseller(el) {
		    const reseller_id = el.getAttribute('data-id');
		    const resellerName = $("#reseller_name").text();
		    const del_url = "<?php echo base_url().'admin/resellers/delete'; ?>";
		    Swal.fire({
                    text: "Are you sure you want to delete " + resellerName + "?",
                    icon: "warning",
                    ...
                    if (result.value) {
                        $.ajax({
                            ...
                            success: function(response) {
                                ...
                                if (response.status == 'success') {
                                    Swal.fire({
                                        text: "You have deleted " + resellerName + "!.",
                                        icon: "success",
                                        buttonsStyling: false,
                                    	...
                                    	const redirect_url = "<?php echo base_url().'admin/resellers/'; ?>";
                        ...
                        Swal.fire({
                            text: resellerName + " was not deleted.",
                            icon: "error",
                            buttonsStyling: false,
                            confirmButtonText: "Ok, got it!",
                            customClass: {
