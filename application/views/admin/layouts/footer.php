	...
	<div class="modal-dialog modal-dialog-centered mw-650px">
		...
		<div class="modal-content">
				...
				<div class="modal-body py-10 px-lg-17 text-center">
					...
					<!--end::Wrapper-->
					<!--begin::Illustration-->
					<div class="d-flex flex-row-auto bgi-no-repeat bgi-position-x-center bgi-size-contain bgi-position-y-bottom min-h-75px min-h-lg-150px" style="background-image: url(assets/media/illustrations/unitedpalms-1/9.png"></div>
					<!--end::Illustration-->
				</div>
				<!--end::Modal body-->
				<!--begin::Modal footer-->
