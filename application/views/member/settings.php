							...
							<div class="card-body border-top p-9">
								...
								<div class="d-flex flex-wrap align-items-center">
									...
									<div id="kt_signin_email_edit" class="flex-row-fluid d-none">
										<!--begin::Form-->
										<form id="kt_signin_change_email" action="<?php echo base_url().'member/change_email/' ?>" class="form" novalidate="novalidate">
											<div class="row mb-6">
								...
								<div class="d-flex flex-wrap align-items-center mb-10">
									...
									<div id="kt_signin_password_edit" class="flex-row-fluid d-none">
										<!--begin::Form-->
										<form id="kt_signin_change_password" action="<?php echo base_url().'member/change_password/' ?>" class="form" novalidate="novalidate">
											<div class="row mb-1">
												<div class="col-lg-4">
													<div class="fv-row mb-0">
