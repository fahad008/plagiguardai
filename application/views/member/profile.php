				...
				<?php $this->load->view('member/navbar'); ?>
					...
					<div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
						...
						<div class="card-header cursor-pointer">
							...
							<!--end::Card title-->
							<!--begin::Action-->
							<a href="<?php echo base_url().'member/update'; ?>" class="btn btn-primary align-self-center">Update Profile</a>
							<!--end::Action-->
						</div>
						<!--begin::Card header-->
						<!--begin::Card body-->
						<div class="card-body p-9">
							...
							<div class="row mb-7">
								...
								<!--begin::Col-->
								<div class="col-lg-8">
									<span class="fw-bolder fs-6 text-gray-800">Customer</span>
								</div>
								<!--end::Col-->
							</div>
							<!--end::Row-->
							...
							<div class="row mb-7">
								...
								<!--begin::Col-->
								<div class="col-lg-8">
									<span class="fw-bolder fs-6 text-gray-800"><?php if (isset($customer_info) && !empty($customer_info)) { echo $customer_info['first_name'].' '.$customer_info['last_name']; } ?></span>
								</div>
								<!--end::Col-->
							</div>
							<!--end::Row-->
							...
							<div class="row mb-7">
								...
								<div class="col-lg-8 fv-row">
									<span class="fw-bold text-gray-800 fs-6"><?php if (isset($customer_info) && !empty($customer_info)) { echo $customer_info['email']; } ?></span>
							...
							<div class="row mb-7">
								...
								<div class="col-lg-8 d-flex align-items-center">
									<span class="fw-bolder fs-6 text-gray-800 me-2"><?php if (isset($customer_info) && !empty($customer_info)) { if ($customer_info['contact_number'] != '') {
										echo $customer_info['contact_number']; }else{ echo "-----------"; } } ?></span>
								</div>
								<!--end::Col-->
							</div>
							<!--end::Input group-->
							...
							<div class="row mb-7">
								...
								<!--begin::Col-->
								<div class="col-lg-8">
									<span class="fw-bolder fs-6 text-gray-800"><?php if (isset($country) && is_array($country) && !empty($country)) {
										echo $country['name'];
									}else{ echo '-----------'; } ?></span>
								</div>
								<!--end::Col-->
							...
							<div class="row mb-7">
								<!--begin::Label-->
								<label class="col-lg-4 fw-bold text-muted">Subscription Type</label>
								<!--end::Label-->
								<!--begin::Col-->
								<div class="col-lg-8">
									<span class="badge badge-light-<?php echo $customer_plan['color']; ?> fw-bolder me-auto px-4 py-3"><?php echo strtoupper($customer_plan['title']); ?></span>
								</div>
								<!--end::Col-->
							</div>
							<?php } ?>
							...
							<div class="row mb-7">
								<!--begin::Label-->
								<label class="col-lg-4 fw-bold text-muted">Terms & Conditions</label>
								<!--end::Label-->
								<!--begin::Col-->
								<div class="col-lg-8">
									<span class="fw-bolder fs-6 text-gray-800">Accepted</span>
								</div>
								<!--end::Col-->
							</div>
							<!--end::Input group-->
							<?php if ($customer_info['email_verified'] == 'no') { ?>
							<!--begin::Notice-->
							<div class="notice d-flex bg-light-warning rounded border-warning border border-dashed p-6">
								...
								<div class="d-flex flex-stack flex-grow-1">
									...
									<div class="fw-bold">
										...
										<div class="fs-6 text-gray-700">Email verification is required to continue using all features. Please click <a class="fw-bolder" id="send-email" href="Javascript: void(0)">here</a> to confirm your email and secure your account.</div>
									</div>
									<!--end::Content-->
								</div>
								<!--end::Wrapper-->
...
<script>
	$(document).ready(function() {
		...
		$('#send-email').click(function(e) {
	        ...
	        // Disable link
	        $link.css('pointer-events', 'none');   // prevent clicks
	        $link.css('opacity', '0.6');           // visually show disabled
	        $link.text('Sending...');              // optional: show status

	        if (clicked) {
	        	$.ajax({
		            url: '<?= base_url("member/send_email") ?>',
		            type: 'POST',
		            data: {
		                action: 'send_email',
		            },
