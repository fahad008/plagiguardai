							...
							<div class="notice d-flex bg-light-warning rounded border-warning border border-dashed p-6">
								...
								<div class="d-flex flex-stack flex-grow-1">
									...
									<div class="fw-bold">
										...
										<div class="fs-6 text-gray-700">Email verification is required to continue using all features. Please click <a class="fw-bolder" href="Javascript: void(0)">here</a> to confirm your email and secure your account.</div>
									</div>
									<!--end::Content-->
								</div>
								<!--end::Wrapper-->
