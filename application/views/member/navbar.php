	...
	<div class="card-body pt-9 pb-0">
		...
		<div class="d-flex overflow-auto h-55px">
			<ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bolder flex-nowrap">
				<!--begin::Nav item-->
				<li class="nav-item">
					<a class="nav-link text-active-primary me-6 <?php if(isset($active) && $active == 'overview'){ echo 'active'; } ?>" href="<?php echo base_url().'member/profile'; ?>">Overview</a>
				</li>
				<!--end::Nav item-->
				<!--begin::Nav item-->
				<li class="nav-item">
					<a class="nav-link text-active-primary me-6 <?php if(isset($active) && $active == 'update'){ echo 'active'; } ?>" href="<?php echo base_url().'member/update'; ?>">Profile Update</a>
				</li>
				<!--end::Nav item-->
				<!--begin::Nav item-->
				<li class="nav-item">
					<a class="nav-link text-active-primary me-6 <?php if(isset($active) && $active == 'settings'){ echo 'active'; } ?>" href="<?php echo base_url().'member/settings'; ?>">Settings</a>
				</li>
				<!--end::Nav item-->
			</ul>
		</div>
