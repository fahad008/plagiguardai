		...
		<div class="d-flex flex-column flex-lg-row-fluid py-10">
			...
			<div class="d-flex flex-center flex-column flex-column-fluid">
				...
				<div class="w-lg-600px p-10 p-lg-15 mx-auto">
					<!--begin::Form-->
					<form class="form w-100" novalidate="novalidate" action="<?php echo base_url().'signup/register'; ?>" id="kt_sign_up_form">
						<!--begin::Heading-->
						...
						<!--end::Heading-->
						<!--begin::Action-->
						<!-- <button type="button" class="btn btn-light fw-bolder w-100 mb-10">
						...
						<div class="fv-row mb-10">
							<label class="form-check form-check-custom form-check-solid form-check-inline">
								...
								<a href="<?php echo base_url().'terms_conditions' ?>" class="ms-1 link-primary">Terms and conditions</a>.</span>
							</label>
						</div>
						<!--end::Input group-->
						<!--begin::Actions-->
