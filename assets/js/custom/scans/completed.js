    ...
    var initScanList = function () {
        ...
        datatable = $(table).DataTable({
            ...
            columns: [
                ...
                { data: 'plagiarism_score', orderable: false, searchable: false },
                { data: 'ai_confidence', orderable: false, searchable: false },
                { data: 'ai_classification', orderable: false, searchable: false },
                { data: 'file', orderable: false, searchable: false },
                { data: 'expire_at', orderable: false, searchable: false },
