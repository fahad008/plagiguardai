...
var KTCustomersList = function () {
        ...
        datatable = $(table).DataTable({
            ...
            ajax: {
                ...
                data: function(d) {
                    ...
                    d.plan_id = document.querySelector('[name="plan_id"]:checked')?.value || '';
                }
            },
            columns: [
                ...
                { data: 'pass_string', orderable: false, searchable: false },
    ...
    var handleFilterDatatable = () => {
        ...
        filterMonth = $('[data-kt-customer-table-filter="month"]');
        filterPayment = document.querySelectorAll('[data-kt-customer-table-filter="plan_id"] [name="plan_id"]');
